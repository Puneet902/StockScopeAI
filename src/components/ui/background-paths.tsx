...
function FloatingPaths({ position, theme }: { position: number; theme: 'dark' | 'light' }) {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none">
            <svg
                className={theme === 'dark' ? 'w-full h-full text-white' : 'w-full h-full text-slate-950'}
                viewBox="0 0 696 316"
                fill="none"
            >
                ...
                >
                    ...
                    {subtitle && (
                        <motion.p
                            ...
                            className={`text-lg md:text-xl mb-12 tracking-wide ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}
                        >
                            {subtitle}
                        </motion.p>
                    )}
